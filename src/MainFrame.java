...
public class MainFrame extends JFrame {
    ...
    public Double calculate1(Double x, Double y, Double z) {
        if (x==0) {
            ...
            Image im;
            im = kit.getImage("C:\\Users\\smn27\\Downloads\\photo_2022-12-05_15-17-27.jpg").getScaledInstance(200, 100, Image.SCALE_SMOOTH);
    ...
    private void addRadioButtonF(String buttonName, final int formulaId) {
        ...
        button.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ev) {
                ...
                if (formulaId == 1)
                    im = kit.getImage("C:\\Users\\smn27\\Downloads\\func2.png").getScaledInstance(600, 100, Image.SCALE_SMOOTH);
                else
                    im = kit.getImage("C:\\Users\\smn27\\Downloads\\func1.png").getScaledInstance(600, 100, Image.SCALE_SMOOTH);
